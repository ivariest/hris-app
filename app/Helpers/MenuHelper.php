...
class MenuHelper
{
    ...
    public static function getHumanResourceItems()
    {
        return [
            [
                'icon' => 'user-profile',
                ...
                'subItems' => [
                    ['name' => 'Employee', 'path' => '/employees', 'pro' => false],
                    ['name' => 'Employee Agreement', 'path' => '/employee-agreements', 'pro' => false],
                    ['name' => 'Mutation', 'path' => '/employee-mutations', 'pro' => false],
                    ['name' => 'Promotion', 'path' => '/employee-promotions', 'pro' => false],
                    ['name' => 'Demotion', 'path' => '/employee-demotions', 'pro' => false],
                    ['name' => 'Deactivate Employees', 'path' => '/employee-deactivations', 'pro' => false],
                    ['name' => 'Turn Over Report', 'path' => '/turn-over-report', 'pro' => false],
                ],
            ],
            [
                'icon' => 'forms',
                'name' => 'Recruitment',
                'subItems' => [
                    ['name' => 'New Employee Request', 'path' => '/recruitment-requests', 'pro' => false],
                    ['name' => 'Candidate', 'path' => '/recruitment-candidates', 'pro' => false],
                    ['name' => 'Report', 'path' => '/recruitment-report', 'pro' => false],
                ],
            ],
            [
                'icon' => 'calendar',
                'name' => 'Attandance',
                'subItems' => [
                    ['name' => 'Import Fingerprint', 'path' => '/attendance-imports', 'pro' => false],
                    ['name' => 'Attendance Recap', 'path' => '/attendance-recap', 'pro' => false],
                    ['name' => 'Attandance Report', 'path' => '/attendance-report', 'pro' => false],
                    ['name' => 'Annual Leave', 'path' => '/annual-leaves', 'pro' => false],
                    ['name' => 'Allowance Report', 'path' => '/allowance-report', 'pro' => false],
                    ['name' => 'Shift Setting', 'path' => '/attendance-shifts', 'pro' => false],
                    ['name' => 'Holiday Setting', 'path' => '/attendance-holidays', 'pro' => false],
                ],
            ],
        ];
    }

    public static function getRecruitmentItems()
    {
        return [
            [
                'icon' => 'forms',
    ...
    public static function getGeneralAffairItems()
    {
        return [
            [
                'icon' => 'task',
                'name' => 'Kendaraan Asset',
                'subItems' => [
                    ['name' => 'Daftar Kendaraan', 'path' => '/general-affair/vehicles', 'pro' => false],
                    ['name' => 'Service Kendaraan', 'path' => '/general-affair/vehicle-services', 'pro' => false],
                ],
            ],
            [
                'icon' => 'forms',
                'name' => 'Kendaraan Rental',
                'path' => '/general-affair/kendaraan-rental',
            ],
        ];
    }

    public static function getAdminAccessItems()
    {
        return [
            [
                'icon' => 'pages',
                ...
                'subItems' => [
                    ...
                    ['name' => 'Sub Departments', 'path' => '/sub-departments', 'pro' => false],
                    ['name' => 'Position Levels', 'path' => '/position-levels', 'pro' => false],
    ...
    public static function getMenuGroups()
    {
        return array_values(array_filter([
            ...
            [
                ...
                'items' => self::getHumanResourceItems()
            ],
            [
                'title' => 'General Affair',
                'items' => self::getGeneralAffairItems()
            ],
            [
                'title' => 'Admin Access',
                'items' => self::getAdminAccessItems()
            ],
            [
                'title' => 'System',
