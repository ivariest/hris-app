...
<aside id="sidebar"
    ...
    x-data="{
        ...
        isActive(path) {
            ...
            const currentPath = normalizePath(window.location.pathname || '{{ $currentPath }}');
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/" class="flex items-center gap-3">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                src="{{ asset('images/logo/standardpen-logo.png') }}" alt="StandardPen logo" width="156" height="40"
                class="h-10 w-auto object-contain" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="{{ asset('images/logo/standardpen-logo.png') }}" alt="StandardPen logo" width="36" height="36"
