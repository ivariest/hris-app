...
@section('content')
    <x-common.page-shell title="Update Promotion" description="Resolve a temporary assignment by making it permanent or returning the employee to the previous position.">
