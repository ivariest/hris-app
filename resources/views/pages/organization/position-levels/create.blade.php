@extends('layouts.app')
@section('content')
    <x-common.page-shell title="Create Position Level" description="Add a new standardized position level.">
        ...
        <form method="POST" action="{{ route('position-levels.store') }}">@csrf @include('pages.organization.position-levels._form')</form>
    </x-common.page-shell>
@endsection
