@extends('layouts.app')
@section('content')
    <x-common.page-shell title="Create Location" description="Add a new office or site location.">
        ...
        <form method="POST" action="{{ route('locations.store') }}">@csrf @include('pages.organization.locations._form')</form>
    </x-common.page-shell>
@endsection
