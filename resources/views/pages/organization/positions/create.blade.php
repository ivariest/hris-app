@extends('layouts.app')
@section('content')
    <x-common.page-shell title="Create Position" description="Add a new position under a sub department and level.">
        ...
        <form method="POST" action="{{ route('positions.store') }}">@csrf @include('pages.organization.positions._form')</form>
    </x-common.page-shell>
@endsection
